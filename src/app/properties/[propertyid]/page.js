...
async function Property(params) {
  ...
  return (
    <>
      ...
      <div className={styles.bottomContainer} id='#Properties By Builder'>
        <div>
          <PropertyBuilder />
        </div>
        <div>
        ...
        <p className='text-xs md:text-sm text-justify mb-5'>The material and information contained herein is for general informational purposes only, and does not constitute an endorsement/warranty/ representation/offer from Dealacres.com.<br />
